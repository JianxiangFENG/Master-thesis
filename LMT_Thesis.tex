...
\newglossaryentry{WRGBD}{name=WRGBD, description={Waschington RGBD Dataset\cite{lai2011large}},first={Waschington RGBD Dataset (WRGBD)\cite{lai2011large}}}
...
\include{Approach}
%\include{BayesianNeuralNetwork}
%\include{ConditionalRandomField}
\include{ExperimentsAndDiscussion}
%\include{Results}
