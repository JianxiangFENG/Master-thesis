...
\begin{figure}[H]
	\begin{center}
		\includegraphics[height=4cm, width=12cm]{cdp_dropout1}	
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[height=4cm, width=12cm]{cdp_dropout2}	
