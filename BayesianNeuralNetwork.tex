...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[height=9cm, width=15cm]{bern_repa_1}
...
\item last but not least, multi-drop can extend the flexibility and diversity of the dropout approximate distribution family by adding more parameters.  
\end{itemize}
