...
\begin{table}[h!]
	...
	\end{tabular}
\end{table}
From the description of settings we know that predictions with most confidence and least confidence are imbalanced in number of data sample of each category. Based on the results in the table \ref{table:fine_tuning}, we can have the following observations:
\begin{itemize}
...
In the following, we show the testing results of CRF trained with two different unary features from two different versions of ResNet50.
 
\begin{table}[H]
	\centering
	\begin{tabular}{|l|l|l|}
		\hline
		& \begin{tabular}[c]{@{}l@{}}unary feature \\ from ori\end{tabular} & \begin{tabular}[c]{@{}l@{}}unary feature \\ from cdp\end{tabular} \\ \hline
		unary accuracy & 48.79\%                                                           & 51.94\%                                                           \\ \hline
		CRF accuracy   & 61.21\%                                                           & 65.11\%                                                           \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|c|c|}
		\hline
		& \multicolumn{1}{l|}{node weight $\theta_u$} & \multicolumn{1}{l|}{edge weight $\theta_p$} \\ \hline
		\begin{tabular}[c]{@{}l@{}}unary feature \\ from ori\end{tabular} & 3.744                            & 4.213                            \\ \hline
		\begin{tabular}[c]{@{}l@{}}unary feature \\ from cdp\end{tabular} & 4.635                            & 3.882                            \\ \hline
	\end{tabular}
\end{table}
