...
\begin{figure}[H]
	\begin{center}
		\includegraphics[height=6cm, width=10cm]{uncertainty_estimation/exp1/exp1_reliability}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[height=5.5cm, width=16.5cm]{uncertainty_estimation/reliability_seed3_ensemble_}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|l|l|}
		...
		emsemble\_mdp & \begin{tabular}[c]{@{}l@{}}\textbf{0.032}/\\\textbf{0.170} \end{tabular}                                                                                       & \begin{tabular}[c]{@{}l@{}}\textbf{0.058}/\\0.227  \end{tabular}                                                                                     & \begin{tabular}[c]{@{}l@{}}0.789/\\0.653 \end{tabular}                                                                            & \begin{tabular}[c]{@{}l@{}}\textbf{0.875}/\\0.754  \end{tabular}                                                                                \\ \hline
	\end{tabular}
\end{table}	
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[height=5cm, width=16.5cm]{uncertainty_estimation/laplace/reliabilty_seed3_.eps}
...
\begin{figure}[h!]		
	\centering
	\includegraphics[height=9cm, width=15cm]{uncertainty_estimation/laplace/histo_ood_seed3.eps}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[height=9cm, width=16cm]{uncertainty_estimation/laplace/roc_pr_seed3.eps}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|l|l|}
		...
		cdp          & \begin{tabular}[c]{@{}l@{}}\textbf{0.124}$\pm$0.023/ \\0.288$\pm$0.048\end{tabular}                      & \begin{tabular}[c]{@{}l@{}}0.206$\pm$0.015/ \\0.374$\pm$0.018\end{tabular}                     & \begin{tabular}[c]{@{}l@{}}0.775$\pm$0.008/ \\\textbf{0.783}$\pm$0.022\end{tabular}           & \begin{tabular}[c]{@{}l@{}}0.825$\pm$0.007/ \\\textbf{0.850}$\pm$0.022\end{tabular}                \\ \hline
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[height=4.5cm, width=15.5cm]{uncertainty_estimation/ablation_study/reliability_froFeat_ori_cdp_mdp_combined_seed3_.eps}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[height=8.5cm,width=16cm]{uncertainty_estimation/ablation_study/histo_froFeat_ori_cdp_mdp_ood_seed3.eps}
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[height=6.7cm,width=12cm]{autoLa/exp2/syn_cdp_trn_uncer_hist.eps}
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[height=8cm,width=14cm]{autoLa/exp2/syn_cdp_trn_roc_pr_cali_.eps}
