...
\paragraph{Uncertainty histogram} is a intuitive visual representation for analyzing the statistics of the uncertainty estimation. Compared with normal histogram, there is one difference to stress. In order to make visual effect more clear, \textbf{normalizer} of each type of prediction is the total number of this type of predictions instead of the entire dataset. More concretely, we have three types of predictions when plotting the histogram, which are:
 \begin{itemize}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[height=9cm, width=16.5cm]{uncertainty_estimation/reliability_seed3_ensemble}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|l|}
		\hline
		& accuracy     & brier\_score & \begin{tabular}[c]{@{}l@{}}negative\\ log \\ likelihood\end{tabular} \\ \hline
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|l|l|}
		\hline
		& \begin{tabular}[c]{@{}l@{}}expected\\ calibration\\ error(w/o. OOD/\\ w. OOD)\end{tabular} & \begin{tabular}[c]{@{}l@{}}maximal\\ calibration\\ error(w/o. OOD/\\ w. OOD)\end{tabular} & \begin{tabular}[c]{@{}l@{}}area under\\ ROC\\ (w/o. OOD/\\ w. OOD)\end{tabular} & \begin{tabular}[c]{@{}l@{}}area under\\ PR curve\\ (w/o. OOD/\\ w. OOD)\end{tabular} \\ \hline
		...
		emsemble\_cdp & 0.044/0.042                                                                                      & 0.086/0.093                                                                                     & 0.798/0.811                                                                           & 0.845/0.868                                                                                \\ \hline
		emsemble\_mdp & 0.032/0.170                                                                                      & 0.058/0.227                                                                                     & 0.789/0.653                                                                           & 0.875/0.754                                                                                \\ \hline
	\end{tabular}
\end{table}	
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[height=9cm, width=16.5cm]{uncertainty_estimation/laplace/reliabilty_seed3}
		\caption{Calibration curve of one of three runs.}		
		\label{exp1_reliability}
	\end{center}
\end{figure}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|l|}
		\hline
		& accuracy                                                              & brier score                                                           & \begin{tabular}[c]{@{}l@{}}negative \\ log\\ likelihood\end{tabular}  \\ \hline
		cdp          & 
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[height=9cm, width=16.5cm]{uncertainty_estimation/ablation_study/reliability_froFeat_ori_cdp_mdp_combined_seed3.eps}
		\caption{Calibration curve of one of three runs.}		
		\label{exp1_reliability}
	\end{center}
\end{figure}
