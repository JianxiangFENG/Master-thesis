...
We train our model with objects captured in elevation $30^\circ$ and $60^\circ$ of Subset \RNum{1} (in which we split off 20\% of training set as validation set for model selection in training). The size of training set and validation set is around $\sim$71.0K. Then we test the model on objects captured in elevation $45^\circ$ of both Subset \RNum{1} and Subset \RNum{2}. In this experiment, the objects in Subset \RNum{2} serve as out-of-distribution samples because they are not present during training. The size of test set is around $\sim$35.6K and that of OOD dataset is around $\sim$17.8K. 
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[height=7cm, width=15cm]{uncertainty_estimation/exp1/exp1_histo}
...
\begin{figure}[H]
	\centering
	\begin{center}
		\includegraphics[height=8cm,width=15cm]{autoLa/exp2/class_balance_NoMa_3percMa.eps}
...
\begin{figure}[H]
	\centering
	\begin{center}
		\includegraphics[height=16cm,width=13.5cm]{autoLa/exp2/AutoLaWithMa3perc&NoMa_CFM.eps}
